...
define config.name = _("찰나의 그 아이 (Ephemeral_Life_Resonance)")
...
define config.version = "0.1.1 Beta"
...
define config.save_directory = "Ephemeral_Life_Resonance-1755341713"
